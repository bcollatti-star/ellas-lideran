...
export default function SponsorsSection() {
  return (
    <section id="sponsors" className="bg-white py-24 px-6 relative overflow-hidden">
      ...
      <svg aria-hidden="true" className="absolute top-0 left-0 w-40 h-48 pointer-events-none" viewBox="0 0 170 210" fill="none">
      ...
      <svg aria-hidden="true" className="absolute bottom-0 right-0 w-56 h-56 pointer-events-none opacity-[0.15]" viewBox="0 0 240 240" fill="none">
