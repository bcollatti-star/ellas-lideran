        ...
        <div className="grid md:grid-cols-2 gap-10 items-stretch">
          ...
          <FadeIn direction="left">
            <div className="rounded-3xl overflow-hidden shadow-lg border border-gold/15 h-80 md:h-full min-h-72">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3348.5!2d-60.6505!3d-32.9518!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95b7ab3b3b3b3b3b%3A0x0!2sEstaci%C3%B3n+Fluvial%2C+Rosario%2C+Santa+Fe!5e0!3m2!1ses!2sar!4v1"
                width="100%"
                height="100%"
          ...
          <FadeIn direction="right" delay={100}>
            <div className="flex flex-col justify-center gap-6">
              <div className="flex gap-4 items-start p-6 bg-cream rounded-2xl border border-gold/15">
                ...
                <div>
                  <p className="font-semibold text-charcoal mb-1">La Fluvial</p>
              ...
              <div className="flex gap-4 items-start p-6 bg-cream rounded-2xl border border-gold/15">
                ...
                <div>
                  <p className="font-semibold text-charcoal mb-1">19 de Marzo · 2027</p>
                  <p className="text-charcoal/60 text-sm">Segunda edición de Ellas Lideran Santa Fe</p>
                </div>
              </div>

              <a
                href="https://www.google.com/maps/search/La+Fluvial+Rosario+Santa+Fe"
                target="_blank"
