...
export default function FasesSection() {
  return (
    <section id="fases" className="bg-cream py-24 px-6 relative overflow-hidden">
      ...
      <svg aria-hidden="true" className="absolute -top-4 -left-4 w-28 h-40 sm:w-56 sm:h-80 md:w-72 md:h-96 pointer-events-none opacity-[0.07] z-0" viewBox="0 0 220 320" fill="#3E2F52">
      ...
      <svg aria-hidden="true" className="absolute bottom-0 right-0 w-24 h-24 sm:w-64 sm:h-64 pointer-events-none opacity-[0.16] z-0" viewBox="0 0 280 280" fill="none">
